...
import {
  Loader2, FileText, CheckCircle2, ChevronLeft, ChevronRight,
} from 'lucide-react';

const SUMMARY_STEPS = [
  { id: 1, label: 'Doctors & Type' },
  { id: 2, label: 'Diagnosis & History' },
  { id: 3, label: 'Course & Procedures' },
  { id: 4, label: 'Advice & Medications' },
];
    ...
    if (step === 2) {
      return (
        <div className="space-y-4">
          ...
          <Section title="Present Medical History">
