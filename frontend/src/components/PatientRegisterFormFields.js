...
/** Full patient registration field grid — shared by dashboard register + quick appointment. */
export default function PatientRegisterFormFields({ form, onChange, activeStep = 0 }) {
    ...
    <FormNavContainer mode="grid" className="h-full">
      ...
      {activeStep === 1 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-full">
          <div className="border rounded p-3 bg-gray-50/40 space-y-2">
...
export function patientStepCanProceed(form, stepIndex) {
  if (stepIndex === 0) {
