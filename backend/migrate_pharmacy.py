...
NEW_COLUMNS = [
    ...
    ("medicines", "rate_unit", "VARCHAR(10) DEFAULT 'tablet'"),
    ("pharmacy_sale_items", "sale_qty", "FLOAT"),
    ("pharmacy_sale_items", "sale_qty_unit", "VARCHAR(10) DEFAULT 'tablet'"),
    ("pharmacy_sale_items", "sale_qty_tabs", "FLOAT"),
    ("pharmacy_sale_items", "sale_qty_strips", "FLOAT"),
